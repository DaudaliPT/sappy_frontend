...
class EditPage extends Component {
  ...
  onMoveTo(nextORprevious) {
    ...
    this.serverRequest = axios({
      method: "get",
      url: `api/inv/oitm/info/${this.props.params.itemcode}/${nextORprevious}`
    })
      .then(result => {
        if (result.data)
          ...
          <div className="row">
            <div className="col-md-9    px-md-15 px-0">
              <p className="page-title">
                {/* <img src={"api/inv/oitm/item/barcodepng/" + this.props.params.itemcode} alt={this.props.params.itemcode} style={{ height: "3rem", filter: "opacity(50%)" }} /> */}

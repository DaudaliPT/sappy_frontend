...
exports.prepareDocType = function ({ tableName }) {
    ...
    let itemHover = {
        ...
        render: ({ result, context }) => {
            ...
            if (context.dependentValues.ITEMNAME_2NDLINE) {

                content.push(
                    <tr>
                        <td>
                            {"Ofertas: " + context.dependentValues.ITEMNAME_2NDLINE}
                        </td>
                    </tr>
                );
            }
    ...
    let detailFields = [
        ...
        // { name: "QTBONUS", label: "QTBONUS", type: "quantity", width: 60, editable: true },
        {
            name: "PRICE",
            label: "Preço",
            type: "price",

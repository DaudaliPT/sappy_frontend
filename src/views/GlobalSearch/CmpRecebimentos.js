...
class CmpRecebimentos extends Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
  ...
  render() {
    ...
    return (
      <GlobalSearchPage
        onTabStatusUpdate={newState => this.props.onTabStatusUpdate("recebimentos", newState)}
        searchTags={this.props.searchTags}
        searchText={this.props.searchText}
        searchApiUrl={this.props.searchApiUrl}
        noRecordsMessage="Nenhum recebimento encontrado"
        renderRow={renderRow}
        renderRowHeight={50}
      />
    );
...
CmpRecebimentos.defaultProps = {
  onTabStatusUpdate: newState => {}
};
export default CmpRecebimentos;

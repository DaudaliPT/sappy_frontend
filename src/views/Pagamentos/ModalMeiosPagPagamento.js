...
class ModalMeiosPagPagamento extends Component {
  ...
  onCreatePayment() {
    ...
    let invokeAddDocAPI = () => {
      ...
      // Num recebimento o total de valores a pagar(positivos) é superior aos valores a deduzir(negativos)
      ...
      axios
        .post(`/api/caixa/pagar/${this.state.isPayment ? "payment" : "receipt"}`, data)
        .then(result => {
                  ...
                  <div className="painel-modopag-bottom">
                    <div className="row">
                      ...
                      <div className="col-4 pl-1">
                        <TextBoxNumeric
                          valueType="amount"
                          label={this.state.isPayment ? "Total a pagar" : "Total a pagar"}
                          name="totalPagar"

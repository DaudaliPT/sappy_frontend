...
const tYEStNO_options = [{ value: "Y", label: "Sim" }, { value: "N", label: "Não" }];
...
class CmpCondicoes extends Component {
  ...
  render() {
    ...
    let includColor = "";
    if (this.props.name === "IC") {
      labelChkInclude = "Incluir os seguintes clientes especificos:";
      includeOptionsRoute = "/api/cbo/ocrd/c";
      includColor = "success";
    }
    if (this.props.name === "EC") {
      labelChkInclude = "Excluir os seguintes clientes especificos:";
      includeOptionsRoute = "/api/cbo/ocrd/c";
      includColor = "danger";
    }
    if (this.props.name === "IA") {
      labelChkInclude = "Incluir os seguintes artigos especificos:";
      includeOptionsRoute = "/api/cbo/oitm/";
      includColor = "success";
    }
    if (this.props.name === "EA") {
      labelChkInclude = "Excluir os seguintes artigos especificos:";
      includeOptionsRoute = "/api/cbo/oitm/";
      includColor = "danger";
    }
